Psilocybin DMN Temporal Autocorrelation
================
2024-02-03
...
![](Stats_n_Viz_psil_DMNTA_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
```
    ...
    ## [1] "one sided p (confirmatory of psil): 0.249155138451405"
...
```
    ...
    ## [1] "one sided p (confirmatory of psil): 0.411570889178189"
