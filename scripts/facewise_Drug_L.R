...
# write out t stats
write.csv(T_L,paste0('/scratch/users/apines/DMN/DMN_Prop_Tstats_L_Drug_',as.character(iteration),'.csv'))
write.csv(p_L,paste0('/scratch/users/apines/DMN/DMN_Prop_ps_L_Drug_',as.character(iteration),'.csv'))
