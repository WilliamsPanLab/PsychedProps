...
################ load in MDMA
# baseline
rs1bv=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs1_thetas_R_bv.csv',header=F)
rs2bv=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs2_thetas_R_bv.csv',header=F)
emobv=read.csv('/oak/stanford/groups/leanew1/users/apines/data/emotion_thetas_R_bv.csv',header=F)
gamblingbv=read.csv('/oak/stanford/groups/leanew1/users/apines/data/gambling_thetas_R_bv.csv',header=F)
wmbv=read.csv('/oak/stanford/groups/leanew1/users/apines/data/wm_thetas_R_bv.csv',header=F)
# remove subject 4
rs1bv=rs1bv[-c(4),]
rs2bv=rs2bv[-c(4),]
emobv=emobv[-c(4),]
...
# placebo
rs1pl=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs1_thetas_R_pcb.csv',header=F)
rs2pl=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs2_thetas_R_pcb.csv',header=F)
emopl=read.csv('/oak/stanford/groups/leanew1/users/apines/data/emotion_thetas_R_pcb.csv',header=F)
gamblingpl=read.csv('/oak/stanford/groups/leanew1/users/apines/data/gambling_thetas_R_pcb.csv',header=F)
wmpl=read.csv('/oak/stanford/groups/leanew1/users/apines/data/wm_thetas_R_pcb.csv',header=F)
# remove subject 4
rs1pl=rs1pl[-c(4),]
rs2pl=rs2pl[-c(4),]
emopl=emopl[-c(4),]
...
wmpl$Dosage='Placebo'
# M1
rs1m1=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs1_thetas_R_m1.csv',header=F)
rs2m1=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs2_thetas_R_m1.csv',header=F)
emom1=read.csv('/oak/stanford/groups/leanew1/users/apines/data/emotion_thetas_R_m1.csv',header=F)
gamblingm1=read.csv('/oak/stanford/groups/leanew1/users/apines/data/gambling_thetas_R_m1.csv',header=F)
wmm1=read.csv('/oak/stanford/groups/leanew1/users/apines/data/wm_thetas_R_m1.csv',header=F)
# remove subject 4
rs1m1=rs1m1[-c(4),]
rs2m1=rs2m1[-c(4),]
emom1=emom1[-c(4),]
...
wmm1$Dosage='80mg'
# M2
rs1m2=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs1_thetas_R_m2.csv',header=F)
rs2m2=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs2_thetas_R_m2.csv',header=F)
emom2=read.csv('/oak/stanford/groups/leanew1/users/apines/data/emotion_thetas_R_m2.csv',header=F)
gamblingm2=read.csv('/oak/stanford/groups/leanew1/users/apines/data/gambling_thetas_R_m2.csv',header=F)
wmm2=read.csv('/oak/stanford/groups/leanew1/users/apines/data/wm_thetas_R_m2.csv',header=F)
# remove subject 4
rs1m2=rs1m2[-c(4),]
rs2m2=rs2m2[-c(4),]
emom2=emom2[-c(4),]
...
#################### load in LSD
# placebo
rs1pl=read.csv('/oak/stanford/groups/leanew1/users/apines/data/lsd_thetas_rs1_PCB_R.csv',header=F)
rs2pl=read.csv('/oak/stanford/groups/leanew1/users/apines/data/lsd_thetas_rs2_PCB_R.csv',header=F)
muspl=read.csv('/oak/stanford/groups/leanew1/users/apines/data/lsd_thetas_mus_PCB_R.csv',header=F)
# LSD
rs1lsd=read.csv('/oak/stanford/groups/leanew1/users/apines/data/lsd_thetas_rs1_LSD_R.csv',header=F)
rs2lsd=read.csv('/oak/stanford/groups/leanew1/users/apines/data/lsd_thetas_rs2_LSD_R.csv',header=F)
muslsd=read.csv('/oak/stanford/groups/leanew1/users/apines/data/lsd_thetas_mus_LSD_R.csv',header=F)
# set meanFD 
...
#################### load in psil
rs1BV=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs1_Psil_thetas_R_bv.csv',header=F)
rs2BV=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs2_Psil_thetas_R_bv.csv',header=F)
rs3BV=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs3_Psil_thetas_R_bv.csv',header=F)
rs4BV=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs4_Psil_thetas_R_bv.csv',header=F)
rs5BV=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs5_Psil_thetas_R_bv.csv',header=F)
rs6BV=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs6_Psil_thetas_R_bv.csv',header=F)
# between drugs
rs1BW=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs1_Psil_thetas_R_p.csv',header=F)
rs2BW=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs2_Psil_thetas_R_p.csv',header=F)
rs3BW=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs3_Psil_thetas_R_p.csv',header=F)
rs4BW=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs4_Psil_thetas_R_p.csv',header=F)
rs5BW=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs5_Psil_thetas_R_p.csv',header=F)
rs6BW=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs6_Psil_thetas_R_p.csv',header=F)
# after drug
rs1AF=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs1_Psil_thetas_R_m1.csv',header=F)
rs2AF=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs2_Psil_thetas_R_m1.csv',header=F)
rs3AF=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs3_Psil_thetas_R_m1.csv',header=F)
rs4AF=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs4_Psil_thetas_R_m1.csv',header=F)
rs5AF=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs5_Psil_thetas_R_m1.csv',header=F)
rs6AF=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs6_Psil_thetas_R_m1.csv',header=F)
# during drug
rs1D=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs1_Psil_thetas_R_m2.csv',header=F)
rs2D=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs2_Psil_thetas_R_m2.csv',header=F)
rs3D=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs3_Psil_thetas_R_m2.csv',header=F)
rs4D=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs4_Psil_thetas_R_m2.csv',header=F)
rs5D=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs5_Psil_thetas_R_m2.csv',header=F)
rs6D=read.csv('/oak/stanford/groups/leanew1/users/apines/data/rs6_Psil_thetas_R_m2.csv',header=F)
...
write.csv(mean_thetas, "~/mean_theta_by_drug_RH.csv", row.names = FALSE)
