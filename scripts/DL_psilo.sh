...
#rsync -av --relative /oak/stanford/groups/leanew1/SHARED_DATASETS/private/WashU_psilocybin/${subjName}/./*/func/run_boundaries_tmask.txt /scratch/users/apines/PsiloData/${subjName}/
rsync -av --relative /oak/stanford/groups/leanew1/SHARED_DATASETS/private/WashU_psilocybin/${subjName}/./*/func/rsfMRI_tmask.txt /scratch/users/apines/PsiloData/${subjName}/
