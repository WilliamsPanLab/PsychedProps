...
# spun props
for (n in 1:numSpins){
	rs1=read.csv(paste0('/scratch/users/apines/data/rs1_Psil_propsMerged_Spin_',n,'_FPN.csv'),header=F)
	rs2=read.csv(paste0('/scratch/users/apines/data/rs2_Psil_propsMerged_Spin_',n,'_FPN.csv'),header=F)
	rs3=read.csv(paste0('/scratch/users/apines/data/rs3_Psil_propsMerged_Spin_',n,'_FPN.csv'),header=F)
	rs4=read.csv(paste0('/scratch/users/apines/data/rs4_Psil_propsMerged_Spin_',n,'_FPN.csv'),header=F)
	rs5=read.csv(paste0('/scratch/users/apines/data/rs5_Psil_propsMerged_Spin_',n,'_FPN.csv'),header=F)
	rs6=read.csv(paste0('/scratch/users/apines/data/rs6_Psil_propsMerged_Spin_',n,'_FPN.csv'),header=F)
...
################
for (n in 1:numSpins){
 	rs1=read.csv(paste0('/scratch/users/apines/data/rs1_Psil_FPNMagMerged_Spin_',n,'.csv'),header=F)
        rs2=read.csv(paste0('/scratch/users/apines/data/rs2_Psil_FPNMagMerged_Spin_',n,'.csv'),header=F)
        rs3=read.csv(paste0('/scratch/users/apines/data/rs3_Psil_FPNMagMerged_Spin_',n,'.csv'),header=F)
        rs4=read.csv(paste0('/scratch/users/apines/data/rs4_Psil_FPNMagMerged_Spin_',n,'.csv'),header=F)
        rs5=read.csv(paste0('/scratch/users/apines/data/rs5_Psil_FPNMagMerged_Spin_',n,'.csv'),header=F)
        rs6=read.csv(paste0('/scratch/users/apines/data/rs6_Psil_FPNMagMerged_Spin_',n,'.csv'),header=F)
        # mimic main analysis code
        rs1$Task='rs'
        rs2$Task='rs2'
        rs3$Task='rs3'
...
for (n in 1:numSpins){
	print(n)
        rs1=read.csv(paste0('/oak/stanford/groups/leanew1/users/apines/data/rs1_Psil_FPNTemporalAutoCor_Merged_Spin_',n,'.csv'),header=F)
        rs2=read.csv(paste0('/oak/stanford/groups/leanew1/users/apines/data/rs2_Psil_FPNTemporalAutoCor_Merged_Spin_',n,'.csv'),header=F)
        rs3=read.csv(paste0('/oak/stanford/groups/leanew1/users/apines/data/rs3_Psil_FPNTemporalAutoCor_Merged_Spin_',n,'.csv'),header=F)
        rs4=read.csv(paste0('/oak/stanford/groups/leanew1/users/apines/data/rs4_Psil_FPNTemporalAutoCor_Merged_Spin_',n,'.csv'),header=F)
        rs5=read.csv(paste0('/oak/stanford/groups/leanew1/users/apines/data/rs5_Psil_FPNTemporalAutoCor_Merged_Spin_',n,'.csv'),header=F)
        rs6=read.csv(paste0('/oak/stanford/groups/leanew1/users/apines/data/rs6_Psil_FPNTemporalAutoCor_Merged_Spin_',n,'.csv'),header=F)
        # mimic main analysis code
        rs1$Task='rs'
        rs2$Task='rs2'
        rs3$Task='rs3'
...
for (n in 1:numSpins){
	print(n)
        rs1=read.csv(paste0('/scratch/users/apines/data/rs1_Psil_FPNSegMerged_Spin_',n,'.csv'),header=F)
        rs2=read.csv(paste0('/scratch/users/apines/data/rs2_Psil_FPNSegMerged_Spin_',n,'.csv'),header=F)
        rs3=read.csv(paste0('/scratch/users/apines/data/rs3_Psil_FPNSegMerged_Spin_',n,'.csv'),header=F)
        rs4=read.csv(paste0('/scratch/users/apines/data/rs4_Psil_FPNSegMerged_Spin_',n,'.csv'),header=F)
        rs5=read.csv(paste0('/scratch/users/apines/data/rs5_Psil_FPNSegMerged_Spin_',n,'.csv'),header=F)
        rs6=read.csv(paste0('/scratch/users/apines/data/rs6_Psil_FPNSegMerged_Spin_',n,'.csv'),header=F)
        # mimic main analysis code
        rs1$Task='rs'
        rs2$Task='rs2'
        rs3$Task='rs3'
...
saveRDS(outspins,'~/SpunTDistributions_Psil_FPN.rds')
