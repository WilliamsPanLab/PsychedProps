...
MagAngL_fp='/scratch/users/apines/data/mdma/' + subj + '/' + sesh + '/' + subj + '_' + sesh + '_task-' + task + '_p2mm_masked_Bold_and_Angles_L.mat'
MagAngR_fp='/scratch/users/apines/data/mdma/' + subj + '/' + sesh + '/' + subj + '_' + sesh + '_task-' + task + '_p2mm_masked_Bold_and_Angles_R.mat'
...
output_csv_path='/scratch/users/apines/data/mdma/' + subj + '/' + sesh + '/' + subj + '_' + sesh + '_task-' + task + '_DMN_2dhist.csv'
