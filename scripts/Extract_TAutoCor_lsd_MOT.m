...
% load in MOT
DMN=ft_read_cifti_mod('/oak/stanford/groups/leanew1/users/apines/maps/Network3_fslr.dscalar.nii');
...
writetable(T,[outFP '/' subj '_' sesh '_' task '_TemporalAutoCor_MOT.csv'],'WriteRowNames',true)
