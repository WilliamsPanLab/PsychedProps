...
writetable(T,[outFP '/' subj '_' sesh '_' task '_VISMag.csv'],'WriteRowNames',true)
% save out facewise
writetable(leftAvgMag,[outFP '/' subj '_' sesh '_' task '_VISMags_L.csv'],'WriteRowNames',true)
writetable(rightAvgMag,[outFP '/' subj '_' sesh '_' task '_VISMags_R.csv'],'WriteRowNames',true)
