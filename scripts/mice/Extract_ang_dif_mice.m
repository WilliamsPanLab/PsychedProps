function Extract_ang_dif_mice(FB)
...
for s=1:length(subjList);
	...
	for run=1:6
		...
		ofFP=strjoin([ofFP subjList(s) '_' num2str(run) '_' FB '_Prop_Feats_gro.csv'],'');
...
% save out matrix
writecell(outDF,strjoin(['/oak/stanford/groups/leanew1/users/apines/data/mice_' FB '_propsMerged_mice.csv'],''))
end
