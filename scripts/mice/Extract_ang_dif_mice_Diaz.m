...
% initialize output file, 5 sessions, 1 for name
outDF=cell(length(subjList),6);
% set common fp
...
% save out matrix
writecell(outDF,'/oak/stanford/groups/leanew1/users/apines/data/mice_propsMerged_mice_Diaz.csv')
end
