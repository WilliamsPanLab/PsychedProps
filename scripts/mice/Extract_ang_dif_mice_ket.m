...
subjList={'m7507','m7522','m7531','m7576','m7590'};
...
for s=1:length(subjList);
	...
	for run=1:5
		...
		ofFP=strjoin([ofFP subjList(s) '_' num2str(run) '_Prop_Feats_gro_ket.csv'],'');
...
% save out matrix
writecell(outDF,['/oak/stanford/groups/leanew1/users/apines/data/mice_propsMerged_mice_ket.csv'])
end
