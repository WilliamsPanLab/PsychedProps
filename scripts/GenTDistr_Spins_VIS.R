...
for (n in 1:numSpins){
	rs1fp=paste0('/scratch/users/apines/data/rs1_propsMerged_Spin_',n,'_VIS.csv')	
	rs2fp=paste0('/scratch/users/apines/data/rs2_propsMerged_Spin_',n,'_VIS.csv')	
	gamblingfp=paste0('/scratch/users/apines/data/gambling_propsMerged_Spin_',n,'_VIS.csv')	
	wmfp=paste0('/scratch/users/apines/data/wm_propsMerged_Spin_',n,'_VIS.csv')	
	# prop angles
...
for (n in 1:numSpins){
        rs1fp=paste0('/scratch/users/apines/data/rs1_MagsMerged_Spin_',n,'_VIS.csv')
        rs2fp=paste0('/scratch/users/apines/data/rs2_MagsMerged_Spin_',n,'_VIS.csv')
        gamblingfp=paste0('/scratch/users/apines/data/gambling_MagsMerged_Spin_',n,'_VIS.csv')
        wmfp=paste0('/scratch/users/apines/data/wm_MagsMerged_Spin_',n,'_VIS.csv')
        # prop angles
        rs1=read.csv(rs1fp,header=F)
        rs2=read.csv(rs2fp,header=F)
        gambling=read.csv(gamblingfp,header=F)
...
for (n in 1:numSpins){
        rs1fp=paste0('/scratch/users/apines/data/rs1_VISSegMerged_Spin_',n,'.csv')
        rs2fp=paste0('/scratch/users/apines/data/rs2_VISSegMerged_Spin_',n,'.csv')
        gamblingfp=paste0('/scratch/users/apines/data/gambling_VISSegMerged_Spin_',n,'.csv')
        wmfp=paste0('/scratch/users/apines/data/wm_VISSegMerged_Spin_',n,'.csv')
        # prop angles
        rs1=read.csv(rs1fp,header=F)
        rs2=read.csv(rs2fp,header=F)
        gambling=read.csv(gamblingfp,header=F)
...
saveRDS(outspins,'~/SpunTDistributions_MDMA_VIS.rds')
