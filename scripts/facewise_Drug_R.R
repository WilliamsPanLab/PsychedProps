...
write.csv(T_R,paste0('/oak/stanford/groups/leanew1/users/apines/results/DMNProps_Tstats_R_Drug_',as.character(iteration),'.csv'))
write.csv(p_R,paste0('/oak/stanford/groups/leanew1/users/apines/results/DMNProps_ps_R_Drug_',as.character(iteration),'.csv'))
