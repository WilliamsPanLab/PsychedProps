...
```{r}
# prop angles
rs1=read.csv('~/Downloads/rs1_Psil_propsMerged(2).csv',header=F)
rs2=read.csv('~/Downloads/rs2_Psil_propsMerged(2).csv',header=F)
rs3=read.csv('~/Downloads/rs3_Psil_propsMerged(2).csv',header=F)
rs4=read.csv('~/Downloads/rs4_Psil_propsMerged(2).csv',header=F)
rs5=read.csv('~/Downloads/rs5_Psil_propsMerged(2).csv',header=F)
rs6=read.csv('~/Downloads/rs6_Psil_propsMerged(2).csv',header=F)
# set colnames
...
ggplot(donutData, aes(ymax=ymax, ymin=ymin, xmax=4, xmin=3, fill=Category)) +
  ...
  )+guides(fill = guide_legend(title = NULL))+scale_fill_manual(values = c("#FFB200","#0018A8","#9532AA"))
```
