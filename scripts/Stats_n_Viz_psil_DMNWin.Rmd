...
rs1=read.csv('~/Downloads/rs1_Psil_DMNWINMerged.csv',header=F)
rs2=read.csv('~/Downloads/rs2_Psil_DMNWINMerged.csv',header=F)
rs3=read.csv('~/Downloads/rs3_Psil_DMNWINMerged.csv',header=F)
rs4=read.csv('~/Downloads/rs4_Psil_DMNWINMerged.csv',header=F)
rs5=read.csv('~/Downloads/rs5_Psil_DMNWINMerged.csv',header=F)
rs6=read.csv('~/Downloads/rs6_Psil_DMNWINMerged.csv',header=F)
...
# add session order directly from filename
...
saveRDS(allScans,'~/Downloads/Psil_Win_Merged.rds')
```
