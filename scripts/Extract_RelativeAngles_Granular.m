function Extract_RelativeAngles_Granular(subj,sesh,task)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% now load in more granular networks
networks=load(['/oak/stanford/groups/leanew1/users/apines/data/Atlas_Visualize/gro_14Nets_fs4.mat']);
for k=1:14
	...
	AngDistFP=[outFP '/' subj '_' sesh '_' task '_k' num2str(k) '_AngDistMatGran.mat'];
	...
	% write out
	writetable(T,[outFP '/' subj '_' sesh '_' task '_k' num2str(k) '_Prop_Feats_groGran.csv'],'WriteRowNames',true)
