function BUTD_to_Rformat_DES(subj)
% convert to csv for R usage, gonogo and nonconfaces

% filepath 
outFP_L=['/oak/stanford/groups/leanew1/users/apines/OpFlAngDs/DES/' subj '/wm_BUTD_L.mat'];
outFP_R=['/oak/stanford/groups/leanew1/users/apines/OpFlAngDs/DES/' subj '/wm_BUTD_R.mat'];
% load in L     
F_L=load(outFP_L);
% load in R
F_R=load(outFP_R);
...
csv_L=table(matL(:,:));
csv_R=table(matR(:,:));
writetable(csv_L,['/oak/stanford/groups/leanew1/users/apines/OpFlAngDs/DES/' subj '/wm_BUTD_L.csv'])
writetable(csv_R,['/oak/stanford/groups/leanew1/users/apines/OpFlAngDs/DES/' subj '/wm_BUTD_R.csv'])

% filepath 
outFP_L=['/oak/stanford/groups/leanew1/users/apines/OpFlAngDs/DES/' subj '/rs_BUTD_L.mat'];
outFP_R=['/oak/stanford/groups/leanew1/users/apines/OpFlAngDs/DES/' subj '/rs_BUTD_R.mat'];
% load in L     
F_L=load(outFP_L);
% load in R
F_R=load(outFP_R);
...
% filepath 
outFP_L=['/oak/stanford/groups/leanew1/users/apines/OpFlAngDs/DES/' subj '/rs2_BUTD_L.mat'];
outFP_R=['/oak/stanford/groups/leanew1/users/apines/OpFlAngDs/DES/' subj '/rs2_BUTD_R.mat'];
% load in L     
F_L=load(outFP_L);
% load in R
F_R=load(outFP_R);
...
csv_L=table(matL(:,:));
csv_R=table(matR(:,:));
writetable(csv_L,['/oak/stanford/groups/leanew1/users/apines/OpFlAngDs/DES/' subj '/rs2_BUTD_L.csv'])
writetable(csv_R,['/oak/stanford/groups/leanew1/users/apines/OpFlAngDs/DES/' subj '/rs2_BUTD_R.csv'])

% LEGACY COMMENTED OUT UNTIL PROC'ED
% GNG
% filepath 
