...
% write out
writetable(T,[outFP '/' subj '_' sesh '_Prop_Feats_gro_5ht2a.csv'],'WriteRowNames',true)
% save out faceMatrix with subject ID as csv to /scratch/users/apines/gp/PropFeatsTemp
writematrix(faceMatrix,['/scratch/users/apines/gp/PropFeats/' subj '_' sesh '_faceMatrix_gro_5ht2a.csv'])
% save out time series
writematrix(OutTs_L,[outFP '/' subj '_' sesh '_Prop_TS_5ht2a_L.csv'])
writematrix(OutTs_R,[outFP '/' subj '_' sesh '_Prop_TS_5ht2a_R.csv'])
