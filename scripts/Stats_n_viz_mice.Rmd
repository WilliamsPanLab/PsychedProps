...
DMNAngs=read.csv('~/Downloads/mice_Del_propsMerged_mice(1).csv',header=F)
...
ggplot(DMNAngs_long, aes(x = Timepoint, y = Value, color = V1, group = V1)) +
  geom_line() +
  geom_point() +
  labs(title = "Signal direction relative to Gradient of DMN", x = "Timepoint", y = "Value", color = "Variable") +
  theme_minimal()
