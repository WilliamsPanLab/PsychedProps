...
netgiis_L=[funcgiiFolder '' subj '_L_AggNets_3kSmooth.func.gii'];
netgiis_R=[funcgiiFolder '' subj '_R_AggNets_3kSmooth.func.gii'];
...
nets.Lnets=Lnets;
nets.Rnets=Rnets;
save([funcgiiFolder '' subj '_Nets_fs4_Smooth.mat'],'nets')
