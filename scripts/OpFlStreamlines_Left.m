function OpFlStreamlines_Left(subj,sesh,task)
% note this script takes face-space vector fields fom op flow and by probing vertex-localized streamline "propagations", brings us back to vertex-space
% add paths
addpath(genpath('/oak/stanford/groups/leanew1/users/apines/libs/'))
childfp=['/scratch/users/apines/data/mdma/' subj '/' sesh ];
% load in optical flow output
data=load([childfp '/' subj '_' sesh '_' task '_OpFl.mat']);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% uptake surface data
