...
for t =1:3
	...
	writetable(thetas_L_PCB_T,['/oak/stanford/groups/leanew1/users/apines/data/lsd_SDS_' task '_PCB_L.csv'])
	writetable(thetas_L_LSD_T,['/oak/stanford/groups/leanew1/users/apines/data/lsd_SDS_' task '_LSD_L.csv'])
	writetable(thetas_R_PCB_T,['/oak/stanford/groups/leanew1/users/apines/data/lsd_SDS_' task '_PCB_R.csv'])
	writetable(thetas_R_LSD_T,['/oak/stanford/groups/leanew1/users/apines/data/lsd_SDS_' task '_LSD_R.csv'])
end
