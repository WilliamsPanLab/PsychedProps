function Extract_DMNSeg_Spun_lsd(subj,sesh,task)
...
% loop over 10k spun fpns
SpunDMNs=load('/oak/stanford/groups/leanew1/users/apines/FPNspins_32k.mat');
% initialize outputs
...
writetable(T,[outFP '/' subj '_' sesh '_' task '_FPNSeg_Spun.csv'],'WriteRowNames',true)
