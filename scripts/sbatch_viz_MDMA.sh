...
# plot examples
matlab -nodisplay -r "ExampleFrames_Sphere_MDMA('$subj','$sesh','rs1')"
matlab -nodisplay -r "ExampleFrames_Sphere_MDMA('$subj','$sesh','rs2')"
matlab -nodisplay -r "ExampleFrames_Sphere_MDMA('$subj','$sesh','emotion')"
matlab -nodisplay -r "ExampleFrames_Sphere_MDMA('$subj','$sesh','gambling')"
matlab -nodisplay -r "ExampleFrames_Sphere_MDMA('$subj','$sesh','wm')"
