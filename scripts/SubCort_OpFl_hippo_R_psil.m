function SubCort_OpFl_hippo_R_psil(subj,sesh,task)
...
% set hippo R mask
hippo_R_mask = false(size(data,1), size(data,2), size(data,3));
...
% save outputs
outfp=[childfp '/' subj '_HippoR_vf_out_' sesh '_' task '.mat'];
save(outfp,'outputs');
