function OpFl_simulated(subj,sesh,task)
% add paths
...
% load in data
fpL=['/scratch/users/apines/Sim_L_AggTS_' subj '_' sesh '_' task '_3k.mgh'];
fpR=['/scratch/users/apines/Sim_R_AggTS_' subj '_' sesh '_' task '_3k.mgh'];
...
% save out
outFN=['/scratch/users/apines/Simulated_OpFl_' subj '_' sesh '_' task '.mat'];
save(outFN,'us')
