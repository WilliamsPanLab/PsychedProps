...
for (n in 1:numSpins){
	rs1fp=paste0('/scratch/users/apines/data/rs1_propsMerged_Spin_',n,'_FPN.csv')	
	rs2fp=paste0('/scratch/users/apines/data/rs2_propsMerged_Spin_',n,'_FPN.csv')	
	gamblingfp=paste0('/scratch/users/apines/data/gambling_propsMerged_Spin_',n,'_FPN.csv')	
	wmfp=paste0('/scratch/users/apines/data/wm_propsMerged_Spin_',n,'_FPN.csv')	
	# prop angles
...
for (n in 1:numSpins){
        rs1fp=paste0('/scratch/users/apines/data/rs1_MagsMerged_Spin_',n,'_FPN.csv')
        rs2fp=paste0('/scratch/users/apines/data/rs2_MagsMerged_Spin_',n,'_FPN.csv')
        gamblingfp=paste0('/scratch/users/apines/data/gambling_MagsMerged_Spin_',n,'_FPN.csv')
        wmfp=paste0('/scratch/users/apines/data/wm_MagsMerged_Spin_',n,'_FPN.csv')
        # prop angles
        rs1=read.csv(rs1fp,header=F)
        rs2=read.csv(rs2fp,header=F)
        gambling=read.csv(gamblingfp,header=F)
...
for (n in 1:numSpins){
        rs1fp=paste0('/scratch/users/apines/data/rs1_FPNSegMerged_Spin_',n,'.csv')
        rs2fp=paste0('/scratch/users/apines/data/rs2_FPNSegMerged_Spin_',n,'.csv')
        gamblingfp=paste0('/scratch/users/apines/data/gambling_FPNSegMerged_Spin_',n,'.csv')
        wmfp=paste0('/scratch/users/apines/data/wm_FPNSegMerged_Spin_',n,'.csv')
        # prop angles
        rs1=read.csv(rs1fp,header=F)
        rs2=read.csv(rs2fp,header=F)
        gambling=read.csv(gamblingfp,header=F)
...
saveRDS(outspins,'~/SpunTDistributions_MDMA_FPN.rds')
