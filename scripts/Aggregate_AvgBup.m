...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% plot condition maps
L_pl_list=g_ls(['/scratch/users/apines/data/mdma/*/AvgBup_PL_L.mat']);
R_pl_list=g_ls(['/scratch/users/apines/data/mdma/*/AvgBup_PL_R.mat']);
L_bv_list=g_ls(['/scratch/users/apines/data/mdma/*/AvgBup_BV_L.mat']);
R_bv_list=g_ls(['/scratch/users/apines/data/mdma/*/AvgBup_BV_R.mat']);
L_m1_list=g_ls(['/scratch/users/apines/data/mdma/*/AvgBup_M1_L.mat']);
R_m1_list=g_ls(['/scratch/users/apines/data/mdma/*/AvgBup_M1_R.mat']);
L_m2_list=g_ls(['/scratch/users/apines/data/mdma/*/AvgBup_M2_L.mat']);
R_m2_list=g_ls(['/scratch/users/apines/data/mdma/*/AvgBup_M2_R.mat']);
...
Vis_FaceVec(avg_L_dif,avg_R_dif,'~/PL_vs_MDMA_BUPDif.png')
...
avg_R_dif=avg_R-avg_R2;
% plot avg. no drug vs. avg. drug
Vis_FaceVec(avg_L_dif,avg_R_dif,'~/NoDrug_vs_MDMA_BUPDif.png')
