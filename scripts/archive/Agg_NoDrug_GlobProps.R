...
for (s in 1:length(subjvec)){
	...
	Del_baselineFPs=list.files(path=(paste0(childfp,p1[s],'/')),pattern="delayMat.csv")
	Del_pFPs=list.files(path=(paste0(childfp,p2[s],'/')),pattern="delayMat.csv")
	Del_m1FPs=list.files(path=(paste0(childfp,m1[s],'/')),pattern="delayMat.csv")
	Del_m2FPs=list.files(path=(paste0(childfp,m2[s],'/')),pattern="delayMat.csv")
...
# now save em out
saveRDS(pl_outDF,'~/pl_OutDelayDF.rds')
saveRDS(md_outDF,'~/md_OutDelayDF.rds')
