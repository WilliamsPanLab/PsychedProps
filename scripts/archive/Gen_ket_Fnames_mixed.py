...
directory = "/scratch/users/apines/p50_mice/proc/20180324"
...
for folder_name in os.listdir(directory):
    ...
    if os.path.isdir(os.path.join(directory, folder_name)) and "mgkg" in folder_name:
...
with open("/scratch/users/apines/p50_mice/demo/ipynb/sess_ketMixed.txt", "w") as file:
