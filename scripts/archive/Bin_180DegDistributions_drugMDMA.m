...
Subjs=readtable('/oak/stanford/groups/leanew1/users/apines/drug_mdma_csv.csv',ReadVariableNames=false)
...
for s = 1:height(Subjs)
	...
	for session = [2 3]
		...
		sesh=table2array(Subjs(s,session));
...
fn='/oak/stanford/groups/leanew1/users/apines/drug_subsAngHist.csv'
