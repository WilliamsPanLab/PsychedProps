...
write.csv(T_L,paste0('/oak/stanford/groups/leanew1/users/apines/results/ncf_vs_gng_L_ts.csv'))
write.csv(p_L,paste0('/oak/stanford/groups/leanew1/users/apines/results/ncf_vs_gng_L_ps.csv'))
