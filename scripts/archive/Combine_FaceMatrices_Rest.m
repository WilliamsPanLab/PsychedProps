...
writetable(table(VMmedcounts(:,:,1)),'~/str_rs_VMcounts.csv');
writetable(table(Dcounts(:,:,1)),'~/str_rs_Dcounts.csv');
writetable(table(OFCcounts(:,:,1)),'~/str_rs_OFCcounts.csv');
writetable(table(PostMedMotcounts(:,:,1)),'~/str_rs_PMMOTcounts.csv');
writetable(table(PostMedPCCcounts(:,:,1)),'~/str_rs_PMPCCcounts.csv');
writetable(table(AntLatMotcounts(:,:,1)),'~/str_rs_ALMcounts.csv');
writetable(table(SupInscounts(:,:,1)),'~/str_rs_SIcounts.csv');
writetable(table(InfInscounts(:,:,1)),'~/str_rs_IIcounts.csv');
writetable(table(Audcounts(:,:,1)),'~/str_rs_Acounts.csv');
writetable(table(MidCingcounts(:,:,1)),'~/str_rs_MCcounts.csv');
writetable(table(VMlatcounts(:,:,1)),'~/str_rs_VLcounts.csv');
