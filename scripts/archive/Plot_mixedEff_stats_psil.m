% load in t-stats
DrugTs_L=readtable('/scratch/users/apines/taskVerts/valid_Drug_Ts_L_psil.csv');
DrugTs_R=readtable('/scratch/users/apines/taskVerts/valid_Drug_Ts_R_psil.csv');
...
Vis_Vertvec(leftVec,rightVec,'~/Drug_Ts_psil.png')
