...
# set subj to "Gro" to indicate group-level map
subj=Gro

# subject's aggregated network maps (dscalar)
AgNet=${parentfp}/Schaefer2018_100Parcels_7Networks_order.dscalar.nii

# separate hemispheres - left
wb_command -cifti-separate $AgNet COLUMN -metric CORTEX_LEFT ${childfp}/${subj}_L_Schaef100.func.gii 
# right hemi
wb_command -cifti-separate $AgNet COLUMN -metric CORTEX_RIGHT ${childfp}/${subj}_R_Schaef100.func.gii

### resample both hemis to 10k vertices
# left hemisphere
wb_command -metric-resample ${childfp}/${subj}_L_Schaef100.func.gii /oak/stanford/groups/leanew1/users/apines/standard_mesh_atlases/resample_fsaverage/fs_LR-deformed_to-fsaverage.L.sphere.32k_fs_LR.surf.gii /oak/stanford/groups/leanew1/users/apines/standard_mesh_atlases/resample_fsaverage/fsaverage4_std_sphere.L.3k_fsavg_L.surf.gii ADAP_BARY_AREA ${childfp}/${subj}_L_Schaef100_3k.func.gii -area-metrics /oak/stanford/groups/leanew1/users/apines/standard_mesh_atlases/resample_fsaverage/fs_LR.L.midthickness_va_avg.32k_fs_LR.shape.gii /oak/stanford/groups/leanew1/users/apines/standard_mesh_atlases/resample_fsaverage/fsaverage4.L.midthickness_va_avg.3k_fsavg_L.shape.gii -largest

# right hemisphere
wb_command -metric-resample ${childfp}/${subj}_R_Schaef100.func.gii /oak/stanford/groups/leanew1/users/apines/standard_mesh_atlases/resample_fsaverage/fs_LR-deformed_to-fsaverage.R.sphere.32k_fs_LR.surf.gii /oak/stanford/groups/leanew1/users/apines/standard_mesh_atlases/resample_fsaverage/fsaverage4_std_sphere.R.3k_fsavg_R.surf.gii ADAP_BARY_AREA ${childfp}/${subj}_R_Schaef100_3k.func.gii -area-metrics /oak/stanford/groups/leanew1/users/apines/standard_mesh_atlases/resample_fsaverage/fs_LR.R.midthickness_va_avg.32k_fs_LR.shape.gii /oak/stanford/groups/leanew1/users/apines/standard_mesh_atlases/resample_fsaverage/fsaverage4.R.midthickness_va_avg.3k_fsavg_R.shape.gii -largest
