...
for i in {1..4};
	...
	wb_command -metric-smoothing /oak/stanford/groups/leanew1/users/apines/standard_mesh_atlases/resample_fsaverage/fsaverage4_std_sphere.L.3k_fsavg_L.surf.gii ${LinNet} 29 ${LoutNet}
	wb_command -metric-smoothing /oak/stanford/groups/leanew1/users/apines/standard_mesh_atlases/resample_fsaverage/fsaverage4_std_sphere.R.3k_fsavg_R.surf.gii ${RinNet} 29 ${RoutNet}
