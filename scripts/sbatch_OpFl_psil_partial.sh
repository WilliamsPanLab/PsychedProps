...
#matlab -nodisplay -r "SubCort_OpFl_caud_R_psil('$subj','$sesh','rs1')"
#matlab -nodisplay -r "SubCort_OpFl_caud_R_psil('$subj','$sesh','rs2')"
#matlab -nodisplay -r "SubCort_OpFl_caud_R_psil('$subj','$sesh','emotion')"
#matlab -nodisplay -r "SubCort_OpFl_caud_R_psil('$subj','$sesh','gambling')"
#matlab -nodisplay -r "SubCort_OpFl_caud_R_psil('$subj','$sesh','wm')"

#matlab -nodisplay -r "SubCort_OpFl_caud_L_psil('$subj','$sesh','rs1')"
#matlab -nodisplay -r "SubCort_OpFl_caud_L_psil('$subj','$sesh','rs2')"
#matlab -nodisplay -r "SubCort_OpFl_caud_L_psil('$subj','$sesh','emotion')"
#matlab -nodisplay -r "SubCort_OpFl_caud_L_psil('$subj','$sesh','gambling')"
#matlab -nodisplay -r "SubCort_OpFl_caud_L_psil('$subj','$sesh','wm')"

#matlab -nodisplay -r "SubCort_OpFl_hippo_R_psil('$subj','$sesh','rs1')"
#matlab -nodisplay -r "SubCort_OpFl_hippo_R_psil('$subj','$sesh','rs2')"
#matlab -nodisplay -r "SubCort_OpFl_hippo_R_psil('$subj','$sesh','emotion')"
#matlab -nodisplay -r "SubCort_OpFl_hippo_R_psil('$subj','$sesh','gambling')"
#matlab -nodisplay -r "SubCort_OpFl_hippo_R_psil('$subj','$sesh','wm')"

#matlab -nodisplay -r "SubCort_OpFl_hippo_L_psil('$subj','$sesh','rs1')"
#matlab -nodisplay -r "SubCort_OpFl_hippo_L_psil('$subj','$sesh','rs2')"
#matlab -nodisplay -r "SubCort_OpFl_hippo_L_psil('$subj','$sesh','emotion')"
#matlab -nodisplay -r "SubCort_OpFl_hippo_L_psil('$subj','$sesh','gambling')"
#matlab -nodisplay -r "SubCort_OpFl_hippo_L_psil('$subj','$sesh','wm')"
