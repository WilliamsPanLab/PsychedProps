function Extract_DMNMag_Spun_lsd(subj,sesh,task)
% define some paths 
...
networks=load(['/oak/stanford/groups/leanew1/users/apines/VISspins_3k.mat']);
...
writetable(T,[outFP '/' subj '_' sesh '_' task '_VISMag_Spun.csv'],'WriteRowNames',true)
