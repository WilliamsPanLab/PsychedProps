...
```{r}
# prop angles
rs1=read.csv('~/Downloads/rs1_propsMerged(6).csv',header=F)
rs2=read.csv('~/Downloads/rs2_propsMerged(6).csv',header=F)
emo=read.csv('~/Downloads/emotion_propsMerged(6).csv',header=F)
gambling=read.csv('~/Downloads/gambling_propsMerged(6).csv',header=F)
wm=read.csv('~/Downloads/wm_propsMerged(6).csv',header=F)
# set colnames
