...
```{r}
# complexity
rs1=read.csv('~/Downloads/rs1_complexityMerged.csv',header=F)
rs2=read.csv('~/Downloads/rs2_complexityMerged.csv',header=F)
emo=read.csv('~/Downloads/emotion_complexityMerged.csv',header=F)
gambling=read.csv('~/Downloads/gambling_complexityMerged.csv',header=F)
wm=read.csv('~/Downloads/wm_complexityMerged.csv',header=F)
# set colnames
#colnames(rs1)=c('bvProp','pProp','m1Prop','m2Prop','bvTRs','pTRs','m1TRs','m2TRs')
#colnames(rs2)=c('bvProp','pProp','m1Prop','m2Prop','bvTRs','pTRs','m1TRs','m2TRs')
#colnames(emo)=c('bvProp','pProp','m1Prop','m2Prop','bvTRs','pTRs','m1TRs','m2TRs')
