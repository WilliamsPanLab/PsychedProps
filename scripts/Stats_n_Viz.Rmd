...
```{r}
# complexity
rs1=read.csv('~/Downloads/rs1_complexityMerged(1).csv',header=F)
rs2=read.csv('~/Downloads/rs2_complexityMerged(1).csv',header=F)
emo=read.csv('~/Downloads/emotion_complexityMerged(1).csv',header=F)
gambling=read.csv('~/Downloads/gambling_complexityMerged(1).csv',header=F)
wm=read.csv('~/Downloads/wm_complexityMerged(1).csv',header=F)
# set colnames
#colnames(rs1)=c('bvProp','pProp','m1Prop','m2Prop','bvTRs','pTRs','m1TRs','m2TRs')
#colnames(rs2)=c('bvProp','pProp','m1Prop','m2Prop','bvTRs','pTRs','m1TRs','m2TRs')
#colnames(emo)=c('bvProp','pProp','m1Prop','m2Prop','bvTRs','pTRs','m1TRs','m2TRs')
...
dmnseg_model <- lme(DMNFC ~ MeanFD + Drug+RemTs, random = ~ 1 | Subjects, data = mergedDfPropsComplAutoCdmnFC)
...
for (i in 1:num_bootstrap_samples){
  ...
  sa_model <- lme(AutoCor ~ MeanFD + Drug+RemTRs+Task+Complexity+TDProp1, random = ~ 1 | Subjects, data = data)
...
# merged
mergedAmyg=merge(AmygB,mergedDfPropsComplAutoC,by='Subjects')
