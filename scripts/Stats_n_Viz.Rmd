...
# the goal here is to return some CIs to look at non-overlappingness with 
...
for (i in 40:56){
  ...
  print(das_col)
  formula_str <- paste(das_col, "~ MeanFD + RemTRs + TDProp1")
  df = na.omit(VASmerge[,c(das_col,'MeanFD','RemTRs','TDProp1','Subjects')])
...
corvec[18]=summary(model)$tTable[rownames(summary(model)$tTable) == "TDProp1", "t-value"]
