...
# combined sessions for drugs
data_drug=data_m1+data_m2
total_measurements_drug = np.sum(data_drug)
...
normalized_data_drug = data_drug / total_measurements_drug
...
difference_pl_drug = normalized_data_pl - normalized_data_drug
# convert to percent
difference_pl_m1=difference_pl_m1*100
difference_pl_m2=difference_pl_m2*100
difference_pl_drug=difference_pl_drug*100
