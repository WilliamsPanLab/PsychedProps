...
% load in fs5 snr
% left
left_SNR=gifti('/oak/stanford/groups/leanew1/users/apines/maps/psil_L_AggTSNR_10k.func.gii').cdata(:,1);
% right
right_SNR=gifti('/oak/stanford/groups/leanew1/users/apines/maps/psil_R_AggTSNR_10k.func.gii').cdata(:,1);
% Calculate 5th percentile: higher snr than mdma
combined_SNR = [left_SNR; right_SNR];
% estimate in non zero grayords
combined_SNR=combined_SNR(combined_SNR>0);
percentile_15 = prctile(combined_SNR, 5);
...
% set output filepath
Mask_L = ['/oak/stanford/groups/leanew1/users/apines/fs5surf/lh.Mask_SNR_psil.label'];
Mask_R = ['/oak/stanford/groups/leanew1/users/apines/fs5surf/rh.Mask_SNR_psil.label'];
...
left_SNR=gifti('/oak/stanford/groups/leanew1/users/apines/maps/psil_L_AggTSNR_10k.func.gii');
right_SNR=gifti('/oak/stanford/groups/leanew1/users/apines/maps/psil_R_AggTSNR_10k.func.gii');
...
% save out
Mask_L = ['/oak/stanford/groups/leanew1/users/apines/fs5surf/lh.Mask_SNR_psil.func.gii'];
Mask_R = ['/oak/stanford/groups/leanew1/users/apines/fs5surf/rh.Mask_SNR_psil.func.gii'];
