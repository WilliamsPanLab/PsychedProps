...
% load in dmn
DMN_L=gifti([parentfp '/Group_lh_Network_1.func.gii']).cdata; 
DMN_R=gifti([parentfp '/Group_rh_Network_1.func.gii']).cdata; 
...
writetable(table(DMN_L),['~/forDMNspins_L.csv'],'WriteVariableNames',0);
writetable(table(DMN_R),['~/forDMNspins_R.csv'],'WriteVariableNames',0);
% spin em
SpinPermuFS(['~/forDMNspins_L.csv'], ['~/forDMNspins_R.csv'], 10000, '/oak/stanford/groups/leanew1/users/apines/DMNspins.mat');
