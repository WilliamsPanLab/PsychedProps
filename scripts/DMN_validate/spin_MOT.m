...
% load in dmn
DMN_L=gifti([parentfp '/Group_lh_Network_3.func.gii']).cdata; 
DMN_R=gifti([parentfp '/Group_rh_Network_3.func.gii']).cdata; 
...
writetable(table(DMN_L),['~/forMOTspins_L.csv'],'WriteVariableNames',0);
writetable(table(DMN_R),['~/forMOTspins_R.csv'],'WriteVariableNames',0);
% spin em
SpinPermuFS(['~/forMOTspins_L.csv'], ['~/forMOTspins_R.csv'], 10000, '/oak/stanford/groups/leanew1/users/apines/MOTspins.mat');
