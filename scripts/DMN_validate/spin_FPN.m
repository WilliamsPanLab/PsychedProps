...
% load in dmn
DMN_L=gifti([parentfp '/Group_lh_Network_4.func.gii']).cdata; 
DMN_R=gifti([parentfp '/Group_rh_Network_4.func.gii']).cdata; 
...
writetable(table(DMN_L),['~/forFPNspins_L.csv'],'WriteVariableNames',0);
writetable(table(DMN_R),['~/forFPNspins_R.csv'],'WriteVariableNames',0);
% spin em
SpinPermuFS(['~/forFPNspins_L.csv'], ['~/forFPNspins_R.csv'], 10000, '/oak/stanford/groups/leanew1/users/apines/FPNspins.mat');
